...
segments(prt[,1], PIt[,1], prt[,1], PIt[,2],
...
```{r fig-boot}
op <- par(mfrow=c(2,2))
plot(density(pb_pMl0$estimates[,"lambda"]), main="SR Ml0")
plot(density(pb_pMlb$estimates[,"lambda"]), main="SR Mlb")
plot(density(pb_tMl0$estimates[,"lambda"]), main="DD Ml0")
plot(density(pb_tMlb$estimates[,"lambda"]), main="DD Mlb")
par(op)
```

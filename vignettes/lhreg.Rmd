...
describes the mathematical details of singing rate ($SR$) estimation based on
removal sampling and effective detection distance ($DD$) estimation via distance sampling.
